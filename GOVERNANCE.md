coditation has joined Linux Foundation in 2019.
With the new Neutral Home we invite everyone: organizations, teams and individuals relying on coditation Automation in their operations to support the project by giving back and participating in development as well as influence on its future under the Open Governance.

# coditation Governance
This document defines governance policies for the coditation project.
It extends [Technical Charter](https://coditation.com/wp/wp-content/uploads/2020/06/2019-09-03-coditation-Project-Technical-Charter.pdf) for coditation within the Linux Foundation.
...
This group is responsible for all technical oversight of coditation as Open Source Project.

### Maintainer Roles
The current list of maintainers is published and updated in [OWNERS.md](OWNERS.md).
coditation uses a three-tiered system of Maintainer roles:
...
* [Senior Maintainers](OWNERS.md#senior-maintainers-)
  * Have the most in-depth experience with the coditation project and are expected to have the knowledge and insight to lead the project's future, growth, standards and improvement.
  ...
  * Have full owner access to all the resources and platforms that sustain coditation project.
  * Receive **two votes** in the voting process.
* [Maintainers](OWNERS.md#maintainers-)
  * Have good experience with the coditation codebase, expected to provide significant value to the project, helping it grow, improve and succeed.
  * Have full member write access to [coditation](https://github.com/coditation/) and [coditation-Exchange](https://github.com/coditation-exchange) Github organizations, CI/CD, Moderator at [forum](https://forum.coditation.com/), [Slack](https://coditation.com/community-signup) and other Community platforms.
  * Receive **one vote** in the voting process.

### Maintainer responsibilities
* In general dedicate at least 1+ full day per week (summarized) on coditation development.
* Monitor Slack, Forums and other Communication channels with coditation Community (delayed response is perfectly acceptable).
* Attend the Community meetings to discuss the project plans, roadmap and commitments.
* Triage GitHub issues and perform pull request reviews for [coditation](https://github.com/coditation/) and [coditation-Exchange](https://github.com/coditation-exchange/) Github organizations.
  The areas of specialization listed in [OWNERS.md](OWNERS.md) can be used to help with routing
  an issue/question to the right person.
* During GitHub issue triage, apply all applicable [labels](https://github.com/coditation/st2/labels)
  ...
  * see all the Github [**labels**](https://github.com/coditation/st2/labels). Recommended informative balance for the issue is 3-5 labels.
...
* Prioritize the work following [coditation Roadmap](https://docs.coditation.com/latest/roadmap.html) to move the project forward.
...
* Encourage and guide other community members to contribute back to coditation. Even a simple bug report or a one-line documentation PR is a win!
...
* Start helping coditation is easy. A few contributing activities that are highly valued:
  * answer user questions and troubleshoot issues in Community: Slack, Forums, Github
  * triaging issues with [**status: to be verified**](https://github.com/coditation/st2/issues?q=is%3Aissue+is%3Aopen+status+label%3A%22status%3Ato+be+verified%22) will help you to get familiar with the project functionality
  * working on issues tagged as [**good first issue**](https://github.com/coditation/st2/contribute)
  * [**bugs**](https://github.com/coditation/st2/issues?q=is%3Aissue+is%3Aopen+status+label%3Abug) are very important to address and will help you to get more familiar with the codebase
  * enhancements marked with [**refactoring**](https://github.com/coditation/st2/issues?q=is%3Aopen+is%3Aissue+label%3Arefactor) tag
  * any [documentation](https://github.com/coditation/st2docs) improvements are always appreciated
  ...
  * join the *#development* channel in [coditation Slack](https://coditation.com/#community) for more pointers from the current Maintainers
  * help growing community ecosystem by writing technical content about coditation like HOWTOs, Show Cases and Demos, Blog posts, Tutorials. We also accept [guest posts](https://coditation.com/blog/)!
...
Just contributing does not make you a maintainer, it is about building trust with the current maintainers of the project and being a person that they can depend on and trust to make decisions in the best interest of coditation.
...
* Becoming a maintainer generally means that you are going to be spending substantial time (at least 1 full day/week) on coditation for the foreseeable future.
* You should have ability to write a good solid code and collaborate with the team and community.
* Enough effort to understanding of the core project's code base (coditation/st2) and internals.
...
* Maintainers will be proposed to be added to the coditation GitHub organization and Maintainers group of [OWNERS.md](OWNERS.md) via voting.
...
* Conduct at least one coditation release in a Maintainer role (release responsibility is rotated between the maintainers).
